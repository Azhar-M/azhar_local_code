...
# meters_per_degree_lat = 111000  # 111000 meters per degree lat
# meters_per_degree_lon = 111000 * math.cos(math.radians(center_lat)) # 111000 meters * cos(lat(rad)) per degree lon
